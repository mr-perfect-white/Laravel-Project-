          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">User Profile</span>
					...
					<ul class="sidebar-menu">
						<li class="sidebar-item">
							<a class="sidebar-link" href="#" id="authMenuToggle">
							<i class="align-middle" data-feather="user-plus"></i>
							<span class="align-middle">Authorization</span>
							<i class="align-middle submenu-icon" data-feather="chevron-down"></i>
							</a>
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Media</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/comment')}}">
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Comments</span>
            </a>
					</li>
					
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{url('/replies')}}">
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Replies</span>
            </a>
					</li>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
                  <div class="col-lg-6"><h1 class="h3 mb-3">Gallery list </h1></div>
                  <!-- <div class="col-lg-6">
                    <a href="{{url('gallery/upload')}}" class="btn btn-primary">Upload Gallery</a>
                  </div> -->
...
<script>
  ...
  document.getElementById("authMenuToggle").addEventListener("click", function (e) {
